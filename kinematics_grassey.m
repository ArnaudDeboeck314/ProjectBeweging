function [t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,dt3,dt4,dt5,dt6,dt7,dt8,dt9,dt10,dt11,dt12,ddt3,ddt4,ddt5,ddt6,ddt7,ddt8,ddt9,ddt10,ddt11,ddt12] = kinematics_grassey(r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,t1,t2,dt2,ddt2,t_init,t)
...
for k=1:t_size
    ...
    B = [-r11*cos(t11(k))*dt11(k)^2 + r12*cos(t12(k))*dt12(k)^2 + r2*cos(t2(k))*dt2^2 + r2*sin(t2(k))*ddt2;
         ...
         r4*sin(t4(k))*dt4(k)^2+r5*sin(t5(k))*dt5(k)^2-r6*sin(t6(k))*dt6(k)^2-r7*sin(t7(k))*dt7^2;
         ...
         -r3*cos(t3(k))*dt3(k)^2+r5*cos(t5(k))*dt5(k)^2+r2*cos(t2(k))*dt2^2 + r2*sin(t2(k))*ddt2;
         -r3*sin(t3(k))*dt3(k)^2+r5*sin(t5(k))*dt5(k)^2+r2*sin(t2(k))*dt2^2 - r2*cos(t2(k))*ddt2;
         ];
